...
?>
	<script src="javaScripts/createNurse.js"></script>
	<form onsubmit="return validateNurse()" action="" method="post">
		...
		<tr>
			<td>Select Duty at :</td>
			<td>
				<select id="duty" name="duty"><option disabled selected>---Select---</option>
              <?php 
			...
			<td><span id="err_duty"> <?php echo $err_duty;?> </span></td>
		</tr> 	
		<tr>
			<td align="right"><a class="btn btn3" href="adminDashboard.php">Back</a></td>
			<td align="left"><input class="Button" type="submit" name="create" value="submit"></td>
		</tr>
	</table>
	</form>
	<br><br>
